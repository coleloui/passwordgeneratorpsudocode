...
//TODO: ask the user how many character they want in the password -> use a prompt which will be set to a var -> make sure the information is correct -> number -> 8+ or 128-
...
//TODO: take the randomized characters and select the amount the amount the user has chosen for the password length -> add these to a "return array" -> for loop the length for this will be the user password length
